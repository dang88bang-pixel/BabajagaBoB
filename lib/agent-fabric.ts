...
{id:"AG-SUP",name:"Supervisor",role:"Orchestration",kind:"SUPERVISOR",status:"RUNNING",progress:0,task:"Routing and coordination",capabilities:["task.dispatch"],profile:{...base,codeChanges:false,sandboxCreation:false},heartbeatAt:new Date().toISOString(),health:"HEALTHY"},
{id:"AG-PLAN",name:"Planner",role:"Planning",kind:"PLANNER",status:"WAITING",progress:0,task:"Decompose missions",capabilities:["mission.plan"],profile:{...base,codeChanges:false,sandboxCreation:false},heartbeatAt:new Date().toISOString(),health:"HEALTHY"},
{id:"AG-BUILD",name:"Builder",role:"Engineering",kind:"BUILDER",status:"WAITING",progress:0,task:"Implement changes",capabilities:["repo.branch","artifact.write","sandbox.run"],profile:{...base},heartbeatAt:new Date().toISOString(),health:"HEALTHY"},
