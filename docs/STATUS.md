...
| Control Center (40 Abschnitte) | TESTED | `tests/ui/control-center.test.tsx` (vollständige Navigation, echte Daten, Anmeldemaske) und `tests/ui/control-center-api.test.tsx` (38 echte Routen-Handler, Metriken als Prometheus-Text, Secrets ohne Lesezugriff); jede Seite ist an eine reale Serverroute gebunden, leer = „keine Einträge“, fehlend = „nicht verfügbar“; live alle Routen mit 200 geprüft |
...
| Automatisierte Testsuiten | TESTED | **54 Dateien / 336 Tests grün** (Unit 80, Security 113, Integration 105, Regression 15, UI 12, E2E 11), siehe `docs/TESTING.md` |
