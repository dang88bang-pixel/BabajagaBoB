...
| CI | Läufe `36190653383` (Push) und `36190657317` (Pull Request) für Commit `d6d993a` (mit den neuen Pflichtstufen **Sabotageproben** und **Fehlerinjektion am laufenden Dienst**), `36180462845`/`36180466658` für `a00b328`, `36180205113`/`36180211257` für `85091b6` sowie `36180023702`/`36180027553` für `1048b23` – alle grün; davor `36111364798`, `36111369562` (Commit `d7cc37a`), `36110172943`, `36110176872` (Commit `4df8a00`), `36108086985`, `36108091312` (Commit `1d219c2`), `36107372935`, `36107377587` (Commit `b2391bc`), davor `36104924399`, `36104927512`, `36104319789`, `36104323205`, `36097553143`, `36090732676`, `36090186817`, `36086611264` – alle grün |
