...
**Letzter Lauf (2026-09-25):** `201 bestanden, 0 fehlgeschlagen`, Exit 0 — auf
...
**Letzter Lauf (2026-09-25):** `488 bestanden, 0 fehlgeschlagen`, Exit 0 — erweitert um
die Kette „Alarmierung/Backup" (Regelbindung, YAML, idempotenter Lauf, Aufbewahrung)
und die Enrollment-Negativfälle (Geheimnis allein autorisiert nicht); zuvor zweimal
...
**Letzter Lauf (2026-09-25):** `82 bestanden, 0 fehlgeschlagen`, Exit 0 — auf der
Frischinstanz (`:3100`, cgroup-delegiert, `BOB_NS_ISOLATION=on`). Weitere Live-Läufe
derselben Instanz: `scripts/verify-live.sh` **174 / 0**, `scripts/audit-actions.mjs`
**488 / 0**, `scripts/audit-api.sh` **201 / 0**.
