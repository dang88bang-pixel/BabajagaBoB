...
**Letzter verifizierter Lauf:** `npx vitest run` → **54 Dateien, 336 Tests, alle grün**
(Unit 80, Security 113, Integration 105, Regression 15, UI 12, E2E 11); `./node_modules/.bin/tsc --noEmit` fehlerfrei; `npx eslint .` 0 Fehler / 10 Warnungen; `npm run build` erfolgreich.
