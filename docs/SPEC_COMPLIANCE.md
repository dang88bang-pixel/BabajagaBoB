...
| 5. Security Regression Suite | **PASS** – 18 Security-Dateien / 124 Tests, Live-Angriffsblockaden (Schritt 5) samt Evidenz der Verweigerung (`kind=DENIAL`) |
...
| 8. UI-Systemzustände sichtbar | **PARTIAL** – 42 Abschnitte mit sichtbaren Zuständen, gegen echte Routen-Handler getestet (`tests/ui/control-center-api.test.tsx`), aber ohne automatisierte Browser-E2E-Prüfung |
