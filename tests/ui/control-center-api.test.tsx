...
describe("Control Center gegen echte Routen", () => {
  it("zeigt mit Session echte Datensätze aus allen Abschnitten", async () => {
    ...
    for (const section of ["Fehlerfälle", "Agenten", "Missionen", "Objectives", "Aufgaben", "Warteschlange", "Runs", "Sandboxes", "Runtimes", "Evidenz", "Audit", "Provenance", "Timeline / Replay", "Wissen", "Experimente", "Wissenschaft", "Recovery", "Regression", "Creator-Inbox", "Freigaben", "Governance", "Sicherheit", "Datenschutz", "Provider", "Geräte", "Computer Use", "CI/CD-Pipeline", "Tests", "Betrieb/Persistenz", "Werkzeuge", "Skills", "Werkstatt", "Simulation", "Galerie", "Apps"]) {
      await click(section);
